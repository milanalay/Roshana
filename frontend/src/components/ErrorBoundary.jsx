...
class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.error('[NurseReady] Render error caught by ErrorBoundary:', error);
    ...
    if (this.state.hasError) {
      return (
        ...
        >
          ...
          >
            NurseReady encountered an unexpected error. Your data is safe — reload the app to continue.
          </p>
